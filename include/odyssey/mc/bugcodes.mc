...
Severity=Informational
Facility=System
SymbolicName=ODYSSEY_COPYRIGHT_NOTICE
Language=English
\n\nOdyssey is free software, covered by the GNU General Public License,
 and you\n are welcome to change it and/or distribute copies of it under
 certain\n conditions. There is absolutely no warranty for Odyssey.\n
.
...
Language=English
A problem has been detected and Odyssey has been shut down to prevent damage
to your computer.
.
...
for any Odyssey updates you might need.
...
Language=English
A system file that is owned by Odyssey was replaced by an application
...
has prevented Odyssey from operating.  You can determine which component is
...
hardware problem thereby allowing Odyssey to operate.
.
