...
link_directories(${ODYSSEY_SOURCE_DIR}/importlibs ${ODYSSEY_BINARY_DIR}/importlibs ${ODYSSEY_BINARY_DIR}/lib/sdk/crt)

set(CMAKE_RC_COMPILE_OBJECT "<CMAKE_RC_COMPILER> <DEFINES> /I${ODYSSEY_SOURCE_DIR}/include/psdk /I${ODYSSEY_BINARY_DIR}/include/psdk /I${ODYSSEY_SOURCE_DIR}/include /I${ODYSSEY_SOURCE_DIR}/include/odyssey /I${ODYSSEY_BINARY_DIR}/include/odyssey /I${ODYSSEY_SOURCE_DIR}/include/odyssey/wine /I${ODYSSEY_SOURCE_DIR}/include/crt /I${ODYSSEY_SOURCE_DIR}/include/crt/mingw32 /fo <OBJECT> <SOURCE>")
...
if(MSVC_IDE)
    ...
    set(CMAKE_ASM_COMPILE_OBJECT
        "<CMAKE_C_COMPILER> /nologo /X /I${ODYSSEY_SOURCE_DIR}/include/asm /I${ODYSSEY_BINARY_DIR}/include/asm <FLAGS> ${definitions} /D__ASM__ /D_USE_ML /EP /c <SOURCE> > <OBJECT>.tmp"
        "<CMAKE_ASM_COMPILER> /nologo /Cp /Fo<OBJECT> /c /Ta <OBJECT>.tmp")
else()
    # NMake Makefiles
    set(CMAKE_ASM_COMPILE_OBJECT
        "<CMAKE_C_COMPILER> /nologo /X /I${ODYSSEY_SOURCE_DIR}/include/asm /I${ODYSSEY_BINARY_DIR}/include/asm <FLAGS> <DEFINES> /D__ASM__ /D_USE_ML /EP /c <SOURCE> > <OBJECT>.tmp"
        "<CMAKE_ASM_COMPILER> /nologo /Cp /Fo<OBJECT> /c /Ta <OBJECT>.tmp")
endif()
...
macro(macro_mc FILE)
    set(COMMAND_MC mc -r ${ODYSSEY_BINARY_DIR}/include/odyssey -h ${ODYSSEY_BINARY_DIR}/include/odyssey ${CMAKE_CURRENT_SOURCE_DIR}/${FILE}.mc)
endmacro()
...
function(CreateBootSectorTarget2 _target_name _asm_file _binary_file _base_address)
    ...
    add_custom_command(
        OUTPUT ${_temp_file}
        COMMAND ${CMAKE_C_COMPILER} /nologo /X /I${ODYSSEY_SOURCE_DIR}/include/asm /I${ODYSSEY_BINARY_DIR}/include/asm /D__ASM__ /D_USE_ML /EP /c ${_asm_file} > ${_temp_file}
        DEPENDS ${_asm_file})
