 ...
 * Released under the GNU GPL for the Odyssey project
 *
 * This program can be used to spy on a named pipe in Windows NT(+)
 * or Odyssey.  It is particularly intended to be used for
 ...
 * NOTE:
 *
 * This program hasn't really been tested against Odyssey, and has only
