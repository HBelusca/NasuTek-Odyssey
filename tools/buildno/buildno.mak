...
BUILDNO_HOST_CXXFLAGS = -I$(TOOLS_BASE) -Iinclude/odyssey $(TOOLS_CPPFLAGS)

BUILDNO_HOST_LFLAGS = $(TOOLS_LFLAGS)

BUILDNO_VERSION = include$(SEP)odyssey$(SEP)version.h
...
$(BUILDNO_H): $(BUILDNO_TARGET)
	${mkdir} $(INTERMEDIATE_)include$(SEP)odyssey 2>$(NUL)
	$(ECHO_BUILDNO)
