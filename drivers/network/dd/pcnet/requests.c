 ...
 *     borrowed very heavily from the Odyssey ne2000 driver by
 ...
 */
{
  ...
  switch (Oid)
    ...
    case OID_GEN_VENDOR_DESCRIPTION:
        {
          static UCHAR VendorDesc[] = "Odyssey Team";
          CopyFrom = VendorDesc;
