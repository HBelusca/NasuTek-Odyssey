/*
 * PROJECT:     Odyssey i8042 (ps/2 keyboard-mouse controller) driver
 * LICENSE:     GPL - See COPYING in the top level directory
 * FILE:        drivers/input/i8042prt/pnp.c
 * PURPOSE:     IRP_MJ_PNP operations
 * PROGRAMMERS: Copyright 2006-2007 Hervé Poussineau (hpoussin@odyssey.org)
    ...
    IN PPORT_DEVICE_EXTENSION DeviceExtension)
{
    ...
    /* Turn on translation and SF (Some machines don't reboot if SF is not set, see Odyssey bug #1842) */
