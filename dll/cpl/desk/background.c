/* $Id: background.c 49017 2010-10-06 14:13:00Z gedmurphy $
 *
...
/* Add the images in the C:\Odyssey directory and the current wallpaper if any */
static VOID
AddListViewItems(HWND hwndDlg, PDATA pData)
{
    ...
    /* Add all the images in the C:\Odyssey directory. */
