/*
 * Odyssey New devices installation
 * Copyright (C) 2005, 2008 ReactOS Team; (C) 2011 NasuTek Enterprises
 *
 ...
 */
/*
 * PROJECT:         Odyssey Add hardware control panel
 * FILE:            dll/cpl/hdwwiz/hdwwiz.c
 * PURPOSE:         Odyssey Add hardware control panel
 * PROGRAMMER:      Hervé Poussineau (hpoussin@odyssey.org)
