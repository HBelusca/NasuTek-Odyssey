/*
 * Odyssey Serbian (Latin) Keyboard layout
...
ROSDATA DEADKEY dead_key[] = {
   ...
   { DEADTRANS(L'C', 0x201a, 0x00c7, 0x0000) },
   { DEADTRANS(L'c', 0x201a, 0x00e7, 0x0000) },
   { DEADTRANS(L'S', 0x201a, 0x015e, 0x0000) },
   { DEADTRANS(L's', 0x201a, 0x015f, 0x0000) },
   { DEADTRANS(L' ', 0x201a, 0x201a, 0x0000) },
