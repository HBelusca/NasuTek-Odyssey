/*
 * Odyssey Finnish keyboard layout (Based on Swedish keyboard layout)
...
//{ 0x4c, L"Center" },
  ...
  { 0x54, L"<Odyssey>" },
  { 0x56, L"HELP" },
  { 0x5b, L"VASEN <Odyssey>" },
  { 0x5c, L"OIKEA <Odyssey>" },
  { 0x5d, L"Program" },
  { 0, NULL }
};
