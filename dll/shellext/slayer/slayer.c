/*
 * Odyssey Compatibility Layer Shell Extension
 * Copyright (C) 2004 - 2005 ReactOS Team; (C) 2011 NasuTek Enterprises
 *
 ...
 */
/* $Id: slayer.c 43790 2009-10-27 10:34:16Z dgorbachev $
 *
 * PROJECT:         Odyssey Compatibility Layer Shell Extension
 * FILE:            lib/shellext/cplsample/cplsample.c
 * PURPOSE:         Odyssey Compatibility Layer Shell Extension
