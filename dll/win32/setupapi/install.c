 ...
 *           2005-2006 Hervé Poussineau (hpoussin@odyssey.org)
 *
    ...
    IN OUT LPWSTR *ServiceBinary)
{
    ...
    /* Check and fix two things:
       1. Get rid of C:\Odyssey and use relative
          path instead.
    ...
    {
        /* Yes, the first part is the C:\Odyssey\, just skip it */
        ...
        if (ServiceType & SERVICE_WIN32)
        {
            ...
            /* -1 to not count the separator after C:\Odyssey
