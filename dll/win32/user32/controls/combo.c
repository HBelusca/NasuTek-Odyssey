...
// Odyssey already define in include/controls.h We have it here as a sync note.
                                  ...
                                  WPARAM wParam, LPARAM lParam, BOOL unicode )
{
	...
	case WM_SETREDRAW:
		...
		return  0;
	case WM_SYSKEYDOWN:
		if( KF_ALTDOWN & HIWORD(lParam) ) // Odyssey (wine) KEYDATA_ALT
	...
	case CB_LIMITTEXT:
		if( lphc->wState & CBF_EDIT )
			return SendMessageW(lphc->hWndEdit, EM_LIMITTEXT, wParam, lParam);
                break; // Odyssey!!! removed at revision 38715
