/*
 *
 * PROJECT:         Odyssey Picture and Fax Viewer
...
ImageView_LoadSettings()
{
    ...
    if (RegOpenKeyEx(HKEY_CURRENT_USER, _T("Software\\Odyssey\\shimgvw"), 0, KEY_READ, &hKey) == ERROR_SUCCESS)
    {
...
ImageView_SaveSettings(HWND hwnd)
{
    ...
    if (RegCreateKeyEx(HKEY_CURRENT_USER, _T("Software\\Odyssey\\shimgvw"), 0, NULL,
