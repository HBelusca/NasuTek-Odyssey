...
InitializeFmIfsOnce(void)
{
	...
	UNICODE_STRING RegistryPath
		= RTL_CONSTANT_STRING(L"\\REGISTRY\\Machine\\SOFTWARE\\Odyssey\\Odyssey\\CurrentVersion\\IFS");
	HANDLE hKey = NULL;
	...
	/* Read IFS providers from HKLM\SOFTWARE\Odyssey\Odyssey\CurrentVersion\IFS */
