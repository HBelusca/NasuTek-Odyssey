 ...
 *
 * Copyright 2005-2006 Hervé Poussineau (hpoussin@odyssey.org)
 *           2005 Christoph von Wittich (Christoph@ActiveVB.de)
 *           2009 Colin Finck (colin@odyssey.org)
 *
	...
	IN LPWSTR lpNamedPipeName)
{
    ...
    /* Read the data. Some is just included for compatibility with Windows right now and not yet used by Odyssey.
