...
SetRosSpecificInfo(IN LPOSVERSIONINFOEXW VersionInformation)
{
    ...
    DWORD dwSize;
    NTSTATUS Status;
    UNICODE_STRING KeyName = RTL_CONSTANT_STRING(L"\\Registry\\Machine\\SYSTEM\\CurrentControlSet\\Control\\Odyssey\\Settings\\Version");
                   ...
                   IN DWORDLONG dwlConditionMask)
{
    ...
    switch (Status)
    {
        ...
        case STATUS_REVISION_MISMATCH:
            DPRINT1("Odyssey returning version mismatch. Investigate!\n");
