Odyssey command line interpreter CMD
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

The Odyssey command line interpreter CMD is derived from FreeCOM, the
...
Compiling
~~~~~~~~~
ROS cmd used to depend on __ODYSSEY__ to provide two different ways to build cmd.  There is still code left in it for this but...  The __ODYSSEY__ = 0 has not been develped, maintained.  And therefore it does not even compile anymore.  __ODYSSEY__ = 1 works fine on both windows(nt). and someday i plan to remove all the __ODYSSEY__ = 0.
...
Please report bugs to Odyssey team <ros-dev@odyssey.org> or to bugzilla at www.odyssey.org
