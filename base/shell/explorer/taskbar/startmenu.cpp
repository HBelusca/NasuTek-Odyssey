...
/*		StartMenuFolders new_folders;
...
#ifndef ROSSHELL
#ifdef __ODYSSEY__	// to be removed when RAS will be implemented
	...
	// browse menu
	  ...
	  case IDC_NETWORK:
#ifdef __ODYSSEY__	///@todo to be removed when network browsing will be implemented in shell namespace
...
{
#ifndef __ODYSSEY__	///@todo to be removed when SHFindFiles() will be implemented in shell32.dll
...
{
#ifndef __ODYSSEY__	///@todo to be removed when SHFindComputer() will be implemented in shell32.dll
...
#if defined(ROSSHELL) || defined(__ODYSSEY__)	// __ODYSSEY__ to be removed when printer/network will be implemented
