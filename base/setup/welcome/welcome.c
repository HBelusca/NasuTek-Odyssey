 ...
 *  Copyright (C) 2001, 2002, 2003 ReactOS Team; (C) 2011 NasuTek Enterprises
 *
 ...
 */
/* $Id: welcome.c 51374 2011-04-17 09:50:07Z mkupfer $
 *
 * COPYRIGHT:   See COPYING in the top level directory
 * PROJECT:     Odyssey welcome/autorun application
...
#include "../../../include/odyssey/version.h"
#include <windows.h>
#include <string.h>
#include <stdio.h>
#include <tchar.h>
	...
	int nCmdShow)
{
  ...
  if (!LoadString(hInstance, (UINT_PTR)MAKEINTRESOURCE(IDS_APPTITLE), szAppTitle, 80))
    _tcscpy(szAppTitle, TEXT("Odyssey Welcome"));
...
OnPaint(HWND hWnd, WPARAM wParam, LPARAM lParam)
{
  ...
  wsprintf(version, TEXT("Odyssey %d.%d.%d"),
