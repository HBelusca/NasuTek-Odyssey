...
CreateCommonFreeLoaderSections(PINICACHE IniCache)
{
    ...
    /* TitleText=Odyssey Boot Manager */
    IniCacheInsertKey(IniSection,
                      NULL,
                      INSERT_LAST,
                      L"TitleText",
                      L"Odyssey Boot Manager");
    ...
    PWCHAR ArcPath)
{
    ...
    /* Create "Odyssey" section */
    IniSection = IniCacheAppendSection(IniCache, L"Odyssey");
    ...
    /* Create "Odyssey_Debug" section */
    IniSection = IniCacheAppendSection(IniCache, L"Odyssey_Debug");
    ...
    PWCHAR ArcPath)
{
    ...
    i = 1;
    wcscpy(SectionName, L"Odyssey");
    wcscpy(OsName, L"\"Odyssey\"");
    while(TRUE)
    {
        ...
        if (OsIniSection != NULL)
        {
            ...
            {
                if ((KeyData == NULL) ||
                        ( (_wcsicmp(KeyData, L"Odyssey") != 0) &&
                          (_wcsicmp(KeyData, L"\"Odyssey\"") != 0) ))
                {
                    /* This is not a Odyssey entry */
            ...
            if (UseExistingEntry)
            {
                /* BootType is Odyssey. Now check SystemPath */
                ...
                if (NT_SUCCESS(Status))
                {
                    ...
                    {
                        /* This entry is a Odyssey entry, but the SystemRoot does not
        ...
        swprintf(SectionName, L"Odyssey_%lu", i);
        swprintf(OsName, L"\"Odyssey %lu\"", i);
        i++;
    }
