...
{
    {
        4,
        3,
        " Odyssey " KERNEL_VERSION_STR " diegimo programa ",
...
static MUI_ENTRY ltLTWelcomePageEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Jus sveikina Odyssey diegimo programa",
        TEXT_STYLE_HIGHLIGHT
    },
    {
        6,
        11,
        "æi diegimo dalis nukopijuos Odyssey operacin”s sistemos bylas ‘ j◊s÷",
        TEXT_STYLE_NORMAL
    },
    {
        6,
    ...
    },
    {
        8,
        15,
        "\x07  Spauskite ENTER, jei norite diegti Odyssey.",
        TEXT_STYLE_NORMAL
    },
    {
        8,
        17,
        "\x07  Spauskite R, jei norite taisyti Odyssey.",
        TEXT_STYLE_NORMAL
    },
    {
        8,
        19,
        "\x07  Spauskite L, jei norite pamatyti Odyssey licencijos s–lygas.",
        TEXT_STYLE_NORMAL
    },
    {
        8,
        21,
        "\x07  Spauskite F3, jei norite uÿdaryti Odyssey diegimo program–.",
        TEXT_STYLE_NORMAL
    },
    {
        6,
        23,
        "Nor”dami gauti daugiau informacijos apie Odyssey, aplankykite:",
        TEXT_STYLE_NORMAL
    },
    {
        6,
