...
{
    {
        4,
        3,
        " Installation de Odyssey " KERNEL_VERSION_STR " ",
...
static MUI_ENTRY frFRWelcomePageEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Bienvenue … l'installation de Odyssey",
        TEXT_STYLE_HIGHLIGHT
    },
    {
        6,
        11,
        "Cette partie de l'installation copie le SystŠme d'Exploitation Odyssey",
        TEXT_STYLE_NORMAL
    },
    {
        6,
    ...
    },
    {
        8,
        15,
        "\x07  Appuyer sur ENTER pour installer Odyssey.",
        TEXT_STYLE_NORMAL
    },
    {
        8,
        17,
        "\x07  Appuyer sur R pour r‚parer Odyssey.",
        TEXT_STYLE_NORMAL
    },
    {
        8,
        19,
        "\x07  Appuyer sur L pour les Termes et Conditions de Licence Odyssey",
        TEXT_STYLE_NORMAL
    },
    {
        8,
        21,
        "\x07  Appuyer sur F3 pour quitter sans installer Odyssey.",
        TEXT_STYLE_NORMAL
    },
    {
        6,
        23,
        "Pour plus d'informations sur Odyssey, veuiller visiter :",
        TEXT_STYLE_NORMAL
    },
    {
        6,
...
static MUI_ENTRY frFRIntroPageEntries[] =
{
    ...
    },
    {
        6,
        8,
        "L'Installation de Odyssey est en phase de d‚veloppement.",
        TEXT_STYLE_NORMAL
    },
    {
        6,
...
static MUI_ENTRY frFRQuitPageEntries[] =
{
    ...
    },
    {
        10,
        6,
        "Odyssey n'est pas complŠtement install‚",
        TEXT_STYLE_NORMAL
    },
    {
        10,
...
static MUI_ENTRY frFRSuccessPageEntries[] =
{
    ...
    },
    {
        10,
        6,
        "Les composants standards de Odyssey ont ‚t‚ install‚s avec succŠs.",
        TEXT_STYLE_NORMAL
    },
    {
        10,
...
static MUI_ENTRY frFRSelectPartitionEntries[] =
{
    ...
    },
    {
        8,
        13,
        "\x07  Appuyer sur ENTER pour installer Odyssey sur la partition choisie.",
        TEXT_STYLE_NORMAL
    },
    {
        8,
...
static MUI_ENTRY frFRInstallDirectoryEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Setup installe les fichiers de Odyssey sur la partition s‚lectionn‚e.",
        TEXT_STYLE_NORMAL
    },
    {
        6,
        9,
        "Choisissez un repertoire o— vous voulez que Odyssey soit install‚ :",
        TEXT_STYLE_NORMAL
    },
    {
        6,
...
static MUI_ENTRY frFRFileCopyEntries[] =
{
    ...
    },
    {
        11,
        12,
        "Patientez pendant que Odyssey Setup copie les fichiers",
        TEXT_STYLE_NORMAL
    },
    {
        15,
        13,
        "dans le r‚pertoire d'installation de Odyssey.",
        TEXT_STYLE_NORMAL
    },
    {
        20,
...
static MUI_ENTRY frFRPrepareCopyEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Setup pr‚pare votre ordinateur pour copier les fichiers de Odyssey. ",
        TEXT_STYLE_NORMAL
    },
    {
        0,
...
MUI_ERROR frFRErrorEntries[] =
{
    {
        //ERROR_NOT_INSTALLED
        "Odyssey n'est pas complŠtement install‚ sur votre\n"
        "ordinateur. Si vous quittez Setup maintenant, vous devrez\n"
        "lancer Setup de nouveau pour installer Odyssey.\n"
        "\n"
...
MUI_STRING frFRStrings[] =
{
    ...
    "Vous avez choisi d'installer Odyssey sur une nouvelle partition."},
    {STRING_INSTALLONPART,
    "Setup installe Odyssey sur la partition"},
    {STRING_CHECKINGPART,
