 ...
 *  Copyright (C) 2004-2008 ReactOS Team; (C) 2011 NasuTek Enterprises
 *
 ...
 */
/* $Id: odyssey.c 45128 2010-01-17 22:37:09Z mkupfer $
 *
 * COPYRIGHT:   See COPYING in the top level directory
 * PROJECT:     Odyssey GUI first stage setup application
 * FILE:        base/setup/odyssey/odyssey.c
...
struct
{
    ...
    BOOLEAN RepairUpdateFlag; // flag for update/repair an installed odyssey
    // txtsetup.sif data
