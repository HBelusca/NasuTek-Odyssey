...
InitLogs(VOID)
{
    WCHAR szBuf[MAX_PATH] = L"SYSTEM\\CurrentControlSet\\Services\\EventLog\\Odyssey Application Manager\\Odyssey Application Manager";
    ...
    hLog = RegisterEventSourceW(NULL, L"Odyssey Application Manager");
}
