...
LoadSettings(VOID)
{
    ...
    if (RegOpenKeyExW(HKEY_LOCAL_MACHINE, L"Software\\Odyssey\\rapps", 0, KEY_READ, &hKey) == ERROR_SUCCESS)
    {
...
SaveSettings(HWND hwnd)
{
    ...
    if (RegCreateKeyExW(HKEY_LOCAL_MACHINE, L"Software\\Odyssey\\rapps", 0, NULL,
