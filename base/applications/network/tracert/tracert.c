 /*
 * PROJECT:     Odyssey trace route utility
...
Usage(VOID)
{
    ...
    _tprintf(_T("NOTES\n-----\n"
           "- Setting TTL values is not currently supported in Odyssey, so the trace will\n"
           "  jump straight to the destination. This feature will be implemented soon.\n"
           "- Host info is not currently available in Odyssey and will fail with strange\n"
