...
#
#    all (default target)
#        This target builds all of Odyssey.
#
#    module
...
#
#    bootcd
#        This target builds an ISO (Odyssey.iso) from which Odyssey can be booted
#        and installed.
#
#    livecd
#        This target builds an ISO (Odyssey-Live.iso) from which Odyssey can be
#        booted, but not installed.
#
#    install
#        This target installs all of Odyssey to a location specified by the
...
#
#    depends
#        This target does a complete dependency check of the Odyssey codebase.
...
#        check of the Odyssey codebase.
#
#    bootcdregtest
#        This target builds an ISO (Odyssey-RegTest.ISO) which is used for unattended
#        regression testing.
#
#
...
#
#    ROS_ARCH
#        This variable specifies the name of the architecture to build Odyssey for.
...
#
#    ROS_CDOUTPUT
#        This variable controls the name of the Odyssey directory on cdrom.
#        The variable defaults to odyssey.
...
$(error Odyssey's makefiles use GNU Make 3.80+ features, you have $(MAKE_VERSION), you MUST UPGRADE in order to build Odyssey - Sorry)
endif
...
RBUILD_FLAGS := -rOdyssey-$(ARCH).rbuild -DARCH=$(ARCH)
...
BUILDNO_H = $(INTERMEDIATE_)include$(SEP)odyssey$(SEP)buildno.h
