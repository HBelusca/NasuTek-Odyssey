...
const CHAR	OdysseySystemPathPrompt[] = "Enter the path to your Odyssey system directory.\n\nExamples:\n\\ODYSSEY\n\\ROS";
const CHAR	OdysseyOptionsPrompt[] = "Enter the options you want passed to the kernel.\n\nExamples:\n/DEBUG /DEBUGPORT=COM1 /BAUDRATE=115200\n/FASTDETECT /SOS /NOGUIBOOT\n/BASEVIDEO /MAXMEM=64\n/KERNEL=NTKRNLMP.EXE /HAL=HALMPS.DLL";
