...
ARC_DISK_SIGNATURE odyssey_arc_disk_info;
ULONG odyssey_disk_count;
CHAR odyssey_arc_hardware_data[256];
...
VOID
ArmPrepareForOdyssey(IN BOOLEAN Setup)
{
    return;
}
...
ArmHwDetect(VOID)
{
    ...
    odyssey_arc_disk_info.Signature = 0xBADAB00F;
    odyssey_arc_disk_info.CheckSum = 0xDEADBABE;
    odyssey_arc_disk_info.ArcName = "ramdisk(0)";
    odyssey_disk_count = 1;
...
MachInit(IN PCCH CommandLine)
{
    ...
    MachVtbl.PrepareForOdyssey = ArmPrepareForOdyssey;
