/* $Id: machine.h 52526 2011-07-03 23:01:39Z rharabien $
 *
 *  FreeLoader
 *
...
typedef struct tagMACHVTBL
{
  ...
  VOID (*VideoSync)(VOID);
  VOID (*Beep)(VOID);
  VOID (*PrepareForOdyssey)(IN BOOLEAN Setup);
...
VOID MachPrepareForOdyssey(IN BOOLEAN Setup);
...
#define MachPrepareForOdyssey(a)		MachVtbl.PrepareForOdyssey(a)
