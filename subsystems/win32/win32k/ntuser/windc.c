 ...
 * COPYRIGHT:       Copyright 2007 Odyssey
 *
 */
...
// Well, it seems Odyssey calls GetDC with out first creating a desktop DC window!
...
// First time use hax, need to use DceAllocDCE during window display init.
   ...
   /*
      ...
      Reference:
        http://www.odyssey.org/archives/public/ros-dev/2008-July/010498.html
        http://www.odyssey.org/archives/public/ros-dev/2008-July/010499.html
    */
   if (pLE != &LEDce)
   {
          ...
          !(pDCE->DCXFlags & DCX_DCEEMPTY) )
     {
        ...
        else
        {
           if (pDCE->DCXFlags & DCX_DCEBUSY) /* shared cache DCE */
           {
               ...
               * We should change this to TRACE when Odyssey is more stable
               * (for 1.0?).
               */
