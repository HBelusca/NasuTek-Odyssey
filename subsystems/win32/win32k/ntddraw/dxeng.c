/*
 * PROJECT:          Odyssey Win32 Subsystem
...
* Odyssey specific: It is not in use yet?
*SystemResourcesList
*--*/
BOOLEAN
APIENTRY
...
*
* @remarks.
* Odyssey specific: Implementation is incomplete, I do not save the value into the hdev yet.
*
*--*/
DWORD_PTR
APIENTRY
...
DxEngNUIsTermSrv()
{
    /* FIXME Odyssey does not suport terminal server yet, we can not check if we got a connections or not */
    UNIMPLEMENTED;
    return FALSE;
}
